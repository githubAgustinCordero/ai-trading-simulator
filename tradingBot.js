class TradingBot {
    ...
    if (tradeAmount < 10) {
        console.log('ℹ️ No se abre LONG: monto calculado demasiado pequeño o objetivo ya alcanzado', { tradeAmount, investedLongUsd });
        return false;
    }
    ...
    if (tradeAmount < 10) {
        console.log('ℹ️ No se abre SHORT: monto calculado demasiado pequeño o objetivo ya alcanzado', { tradeAmount, investedShortUsd });
        return false;
    }
